...
public interface EmPush2delayApi {
    ...
    String PUSH2DELAY = "push2delay.eastmoney.com";
     ...
     * http://push2delay.eastmoney.com/api/qt/stock/get?secid=1.600986&ut=fa5fd1943c7b386f172d6893dbfba10b&invt=2&fields=f80,f43,f44,f45,f46,f47,f48,f49,f50,f51,f52,f57,f58,f60,f116,f117,f161,f162,f163,f164,f167,f168,f169,f170,f171,f178
     */
    @Get(url = PUSH2DELAY + "/api/qt/stock/get?secid={marketCode}.{code}&ut=fa5fd1943c7b386f172d6893dbfba10b&invt=2&fields={fields}")
     ...
     */
    @Get(url = PUSH2DELAY + "/api/qt/stock/fflow/kline/get?klt={klt}&secid={marketCode}.{code}&lmt=0&fields1=f1,f2,f3,f7&fields2=f51,f52,f53,f54,f55,f56,f57,f58,f59,f60,f61,f62,f63,f64,f65")
